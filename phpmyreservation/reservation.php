...
elseif(isset($_GET['week']))
{
	...
	$days_row = '<tr><td id="reservation_corner_td"><input type="button" class="blue_button small_button" id="reservation_today_button" value="Dnes"></td><th class="reservation_day_th">Pondelok</th><th class="reservation_day_th">Utorok</th><th class="reservation_day_th">Streda</th><th class="reservation_day_th">Štvrtok</th><th class="reservation_day_th">Piatok</th><th class="reservation_day_th">Sobota</th><th class="reservation_day_th">Nedeľa</th></tr>';
...
{
	echo '</div><div class="box_div" id="reservation_div"><div class="box_top_div" id="reservation_top_div"><div id="reservation_top_left_div"><a href="." id="previous_week_a">&lt; Predchádzajúci týždeň</a></div><div id="reservation_top_center_div">Rezervácie pre týžden č. <span id="week_number_span">' . global_week_number . '</span></div><div id="reservation_top_right_div"><a href="." id="next_week_a">Nasledujúci týždeň &gt;</a></div></div><div class="box_body_div"><div id="reservation_table_div"></div></div></div><div id="reservation_details_div">';
}
